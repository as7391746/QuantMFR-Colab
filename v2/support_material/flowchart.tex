...
\node[box, below=4.5mm of det] (steps)
  {Read $g^0$ from the state equations that pin it, checking they agree\\
   (a trial value $0.005$ if none does); start components of $D^0$ at\\
   $0.01$, components of $X^0$ at $0$, and perform the following steps:\\[2pt]
